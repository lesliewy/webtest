...
public class BinarySearchTest {
    ...
    @Test
    public void testBoundSearch() {
        System.out.println(BinarySearch.leftBoundSearch(new int[] { 1, 2, 2, 2, 2, 3 }, 2));
        System.out.println(BinarySearch.rightBoundSearch(new int[] { 1, 2, 2, 2, 2, 3 }, 2));
    }
}
